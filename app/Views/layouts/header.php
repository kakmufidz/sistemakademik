<div class="header align-items-stretch">
    ...
    <div class="header-brand">
        ...
        <div class="btn btn-icon w-auto px-0 btn-active-color-primary aside-minimize" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="aside-minimize">
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            ...
            <div class="d-flex align-items-center overflow-auto pt-3 pt-lg-0">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Label-->
                    <button class="btn btn-light-primary btn-active-light-primary fw-bolder flex-shrink-0"><?= tgl_indo(date("Y-m-d")) ?> <span class="count_time">00:00:00</span> WIB</button>
                    <!--end::Label-->
                </div>
                <!--end::Action wrapper-->
            </div>
