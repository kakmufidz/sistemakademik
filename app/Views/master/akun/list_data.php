            ...
            <div class="card-header">
                ...
                <div class="text-end align-self-center">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true" style="">
                        ...
                        </div><a href="javascript:;" class="menu-link flex-stack px-3" id="export_excel">
                            <!--end::Menu item-->
                        </a>
                    </div><a href="javascript:;" class="menu-link flex-stack px-3" id="export_excel">
                        <!--end::Menu 3-->
            ...
            <div class="card-body pt-0">
                <div class="container mt-4">
                    <div class="loading text-center" style="display: none;">
                        <h1 class="text-primary"><img src="<?= base_url() ?>assets/media/images/loading.gif" class="w-80px" alt="Loading..."> SISKA</h1><br>
                    </div>
