...
class GuzzleApiHm
{
    ...
    public function __construct()
    {
        ...
        $this->apiUrl = env('ACCURATE_API_URL_HM');
        $this->apiPublicUrl = env('ACCURATE_API_PUBLIC_URL_HM');
        $this->accessToken = env('ACCURATE_ACCESS_TOKEN_HM');
        $this->clientId = env('ACCURATE_CLIENT_ID_HM');
        $this->clientSecret = env('ACCURATE_CLIENT_SECRET_HM');
        $signatureSecret = env('ACCURATE_SIGNATURE_SECRET_HM');
