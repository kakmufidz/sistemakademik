...
class AccurateApiServiceHJA
{
    ...
    public function __construct()
    {
        ...
        $this->apiUrl = getenv('ACCURATE_API_URL_HJA');
        $this->apiPublicUrl = getenv('ACCURATE_API_PUBLIC_URL_HJA');
        $this->accessToken = getenv('ACCURATE_ACCESS_TOKEN_HJA');
        $this->clientId = getenv('ACCURATE_CLIENT_ID_HJA');
        $this->clientSecret = getenv('ACCURATE_CLIENT_SECRET_HJA');
        $signatureSecret = getenv('ACCURATE_SIGNATURE_SECRET_HJA');
